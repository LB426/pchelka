...
ActiveRecord::Schema.define(version: 20160518153650) do

  create_table "abonenties", force: :cascade do |t|
    ...
    t.string   "telefon2",   limit: 255
    t.date     "first_d"
    t.time     "first_t"
    t.integer  "first_c",    limit: 4
    t.string   "first_p",    limit: 255
    t.string   "first_a",    limit: 255
    t.date     "second_d"
    t.time     "second_t"
    t.integer  "second_c",   limit: 4
    t.string   "second_p",   limit: 255
    t.string   "second_a",   limit: 255
    t.date     "third_d"
    t.time     "third_t"
    t.integer  "third_c",    limit: 4
    t.string   "third_p",    limit: 255
    t.string   "third_a",    limit: 255
    t.date     "fourth_d"
    t.time     "fourth_t"
    t.integer  "fourth_c",   limit: 4
    t.string   "fourth_p",   limit: 255
    t.string   "fourth_a",   limit: 255
    t.date     "fifth_d"
    t.time     "fifth_t"
    t.integer  "fifth_c",    limit: 4
    t.string   "fifth_p",    limit: 255
    t.string   "fifth_a",    limit: 255
    t.date     "sixth_d"
    t.time     "sixth_t"
    t.integer  "sixth_c",    limit: 4
    t.string   "sixth_p",    limit: 255
    t.string   "sixth_a",    limit: 255
    t.date     "seventh_d"
    t.time     "seventh_t"
    t.integer  "seventh_c",  limit: 4
    t.string   "seventh_p",  limit: 255
    t.string   "seventh_a",  limit: 255
    t.integer  "num_f",      limit: 4
    t.date     "eigth_d"
    t.time     "eigth_t"
    t.integer  "eigth_c",    limit: 4
    t.string   "eigth_p",    limit: 255
    t.string   "eigth_a",    limit: 255
    t.string   "nineth_a",   limit: 255
    t.string   "nineth_p",   limit: 255
    ...
    t.string   "tenth_p",    limit: 255
    t.string   "tenth_a",    limit: 255
    t.string   "eleventh_a", limit: 255
    t.string   "eleventh_p", limit: 255
    ...
    t.string   "p_12",       limit: 255
    t.string   "a_12",       limit: 255
    t.integer  "m_12",       limit: 4
    t.date     "d_13"
    t.time     "t_13"
    t.integer  "c_13",       limit: 4
    t.string   "p_13",       limit: 255
    t.string   "a_13",       limit: 255
    t.integer  "m_13",       limit: 4
    t.date     "d_14"
    t.time     "t_14"
    t.integer  "c_14",       limit: 4
    t.string   "p_14",       limit: 255
    t.string   "a_14",       limit: 255
    t.integer  "m_14",       limit: 4
    t.date     "d_15"
    t.time     "t_15"
    t.integer  "c_15",       limit: 4
    t.string   "p_15",       limit: 255
    t.string   "a_15",       limit: 255
    t.integer  "m_15",       limit: 4
    t.date     "d_16"
    t.time     "t_16"
    t.integer  "c_16",       limit: 4
    t.string   "p_16",       limit: 255
    t.string   "a_16",       limit: 255
